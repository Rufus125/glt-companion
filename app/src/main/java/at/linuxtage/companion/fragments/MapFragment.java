...
public class MapFragment extends Fragment {
	...
	private static final double DESTINATION_LATITUDE = 47.05826;
	private static final double DESTINATION_LONGITUDE = 15.46068;
	private static final String DESTINATION_NAME = "TU Graz";
	...
	private void launchDirections() {
		...
		String uri = String.format(Locale.US,
                ...
                "https://www.openstreetmap.org/#map=17/%1$f/%2$f/%3$s",
